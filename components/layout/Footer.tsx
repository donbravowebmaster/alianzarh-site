          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3.5 mt-6">
              <a
                ...
                className="transition-[color,transform] duration-150 hover:-translate-y-0.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 text-white/50 hover:text-white"
                target="_blank"
